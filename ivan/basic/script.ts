...
let fullName = document.getElementById("full-name") as HTMLElement;
...
let name10 = document.getElementById("name10") as HTMLElement;
...
// Create an array of names, this array should only accept strings.
    ...
    let names : string[] = ["Jon", "Jack", "Jordan", "Michael", "Frank"];
